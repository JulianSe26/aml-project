...
def create_ann(ele):
    ann_path = '../../data/siim-covid19-detection/labels/train/{}.xml'.format(ele.imageid)
    label_path = '../../data/siim-covid19-detection/labels/train/{}.txt'.format(ele.imageid)
...
if __name__ == '__main__':
    os.makedirs('../../data/siim-covid19-detection/labels/train', exist_ok=True)
    os.makedirs('../../data/siim-covid19-detection/folds', exist_ok=True)

    df = pd.read_csv('../../data/siim-covid19-detection/train_kfold.csv')
    ...
    for fold in range(5):
        ...
        for _, row in tmp_df.iterrows():
            image_path = '../../data/siim-covid19-detection/images/train/{}.png'.format(row['imageid'])
    ...
    for fold in range(5):
        ...
        yv5_tf = open("../../data/siim-covid19-detection/folds/yolov5_train_fold{}.txt".format(fold), "w")
        effdet_tf = open("../../data/siim-covid19-detection/folds/effdet_train_fold{}.txt".format(fold), "w")
        ...
        yv5_vf = open("../../data/siim-covid19-detection/folds/yolov5_valid_fold{}.txt".format(fold), "w")
        effdet_vf = open("../../data/siim-covid19-detection/folds/effdet_valid_fold{}.txt".format(fold), "w")
