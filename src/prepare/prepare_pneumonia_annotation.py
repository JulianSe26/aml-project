...
def create_ann(ele):
    ann_path = '../../data/RSNA/labels/train/{}.xml'.format(ele.patientId)
    label_path = '../../data/RSNA/labels/train/{}.txt'.format(ele.patientId)
...
if __name__ == '__main__':
    os.makedirs('../../data/RSNA/labels/train', exist_ok=True)
    ...
    for patientId, grp in df.groupby('patientId'):
        image_path = '../../data/RSNA/images/train/{}.png'.format(patientId)
        boxes = []
