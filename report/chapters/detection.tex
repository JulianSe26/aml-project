...
\textbf{Hier noch bisschen mehr YOLO beschreiben}

\textbf{dann training beschreiben + alle tricks - warmup, multilabel, GIOU, }

As mentioned previously, we did also a pretraining for the \ac{YOLO} model before we trained it to the SIIM COVID-19 dataset. For this we used the RSNA pneumonia detection dataset described in \vref{data:rsna}.
